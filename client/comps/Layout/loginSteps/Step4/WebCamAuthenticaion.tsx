...
import styles from "../../../../styles/LoginSteps/Step4/WebCamAuthentication.module.css"
...
const WebCamAuthentication: FC<WebCamSectionStep4Props> = ({updateImageSrc, makeFalse}) => {
